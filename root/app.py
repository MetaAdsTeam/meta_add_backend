...
def all_handlers():
    return [
        ...
        tornado.web.url(fr"{root.context.uri_prefix}/ad_places",
                        AdPlacesHandler, name=enums.UrlName.ADPLACES.value),
        tornado.web.url(fr"{root.context.uri_prefix}/adspot_type",
                        AdSpotTypeHandler, name=enums.UrlName.ADSPOT_TYPE.value),
        tornado.web.url(fr"{root.context.uri_prefix}/adspot",
                        AdSpotHandler, name=enums.UrlName.ADSPOT.value),
        ...
        tornado.web.url(fr"{root.context.uri_prefix}/contents",
                        ContentsHandler, name=enums.UrlName.CONTENTS.value),
        tornado.web.url(fr"{root.context.uri_prefix}/content_type",
                        ContentTypeHandler, name=enums.UrlName.CONTENT_TYPE.value),
